  ...
  return (
    <Layout>
      ...
      <Section title="6. ユーザー情報の削除">
        ...
        自身のアカウントおよび関連する情報の削除を申請することができます。
        <br />
        削除申請が行われた情報は、法令上保存が必要な場合を除き、
        一定期間経過後に削除されます。
        <br />
        <br />
        <strong>アプリ内での削除手順（iOS/Android共通）</strong>
        <br />
        1. アプリを開き、<strong>マイページ</strong>タブに移動します。
        <br />
        2. <strong>アカウント設定</strong>を選択します。
        <br />
        3. <strong>退会する</strong>ボタンをタップします。
        <br />
        4.
        表示される確認ページで削除を確定すると、アカウントと関連情報が削除されます。
        <br />
        <br />
        また、アプリ内での手続きが難しい場合は、下記のサポート窓口から削除申請が可能です。
        <br />
        メールアドレス：support@mokuyoubi.org
        <br />
        申請内容には、アカウントIDまたは登録メールアドレスを必ず記載してください。
        <br />
        <br />
        本削除方法の手順は、Facebookなど外部サービスの審査にも対応しています。
      </Section>
